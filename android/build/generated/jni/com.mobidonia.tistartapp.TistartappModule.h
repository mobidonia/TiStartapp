...
class TistartappModule : public titanium::Proxy
{
public:
	explicit TistartappModule(jobject javaObject);
...
private:
	...
	static void showStandardInterestial(const v8::FunctionCallbackInfo<v8::Value>&);
	static void showSplash(const v8::FunctionCallbackInfo<v8::Value>&);
	static void example(const v8::FunctionCallbackInfo<v8::Value>&);
	static void onBackPressed(const v8::FunctionCallbackInfo<v8::Value>&);
